...
if __name__ == "__main__":
    ...
    for in_filename in args.in_filenames:
        ...
        h_amplitude.Rebin(3)
        h_amplitude.GetYaxis().SetTitle("Entries / 3mV")
        h_amplitude.Draw()
        c1.SaveAs(f"{args.outputDir}/signal_amplitude_3mVbinning.png")
        ...
        h_amplitude.Fit(g1, "", "", 0.058, 0.065)
        h_amplitude.Fit(g2, "+", "", 0.065, 0.082)
        h_amplitude.Fit(g3, "+", "", 0.08, 0.09);
        h_amplitude.Fit(g4, "+", "", 0.092, 0.105);
        h_amplitude.Fit(g5, "+", "", 0.105, 0.12);
        h_amplitude.Fit(g6, "+", "", 0.116, 0.132);
        h_amplitude.Fit(g7, "+", "", 0.128, 0.145);
        h_amplitude.Fit(g8, "+", "", 0.142, 0.155);
        h_amplitude.Fit(g9, "+", "", 0.153, 0.163);
        h_amplitude.Fit(g10, "+", "", 0.165, 0.178);
        h_amplitude.Fit(g11, "+", "", 0.175, 0.185);
        h_amplitude.Fit(g12, "+", "", 0.189, 0.2);
        ...
        h_amplitude.Fit(total, "+", "", 0.058,0.2)
        h_amplitude.Draw()
        ...
        f1.SetParLimits(1,  0.03,0.05) # first peak mean
        ...
        h_amplitude_2.Draw()
        h_amplitude_2.GetYaxis().SetTitle("Entries / 3mV")
